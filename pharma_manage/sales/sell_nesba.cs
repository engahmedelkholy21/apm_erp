...
{
    public partial class sell_nesba : Form
    {
        public sell_nesba()
        {
            InitializeComponent();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i < dataGridView1.Rows.Count; ++i)
                {
                    ...
                    dataGridView1.Rows[i].Cells[8].Value = (Convert.ToDecimal(dataGridView1.Rows[i].Cells[6].Value) * Convert.ToDecimal(dataGridView1.Rows[i].Cells[3].Value)) +( Convert.ToDecimal(dataGridView1.Rows[i].Cells[7].Value)*Convert.ToDecimal(dataGridView1.Rows[i].Cells[3].Value)) ;
        ...
        private void pro_buttton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                cat_extra = Convert.ToDecimal(dataSet11.Category.Rows[0]["cat_extra"]);
            }
            catch { }
            //string pro_stock = "";
            ...
            if (Convert.ToDecimal(pro_count) >= 1)
            {
                ...
                dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), pro_code, pro_name, 1, unit_price,cat_extra, "", category_name1);
            }
            else
            {
                MessageBox.Show("الكمية غير متاحه في المخزن", "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        private void check_mandoob()
        {
            try
            {
                resp_tableTableAdapter1.FillBy_NAME_OR_PHONE(dataSet11.resp_table, mandoob_txt.Text, resp_phone_txt.Text);
                if (dataSet11.resp_table.Rows.Count <= 0)
                {
                    resp_tableTableAdapter1.Insert(mandoob_txt.Text, resp_phone_txt.Text, "", Convert.ToDecimal(bonus_txt.Text), "",0,0);
                }
                else
                {
                    //int id = Convert.ToInt32(dataSet11.customers.Rows[0]["cst_ID"]);
        ...
        private void delete_sales()
        {
            ...
            if (dataSet11.madeen_small_report.Rows.Count > 0)
            {
                ...
                //decimal old_matloob_madeen = Convert.ToDecimal(dataSet11.madeen_small_report.Rows[0]["madeen_small_matloob"]);
                //decimal old_madfoo3_madeen = Convert.ToDecimal(dataSet11.madeen_small_report.Rows[0]["madeen_small_madfoo3"]);
        ...
        private void save_fatora()
        {
            ...
            foreach (DataGridViewRow dgr in dataGridView1.Rows)
            {
                ...
                if (pro_count == 0)
                {
                    ...
                    if (dataSet11.mo3adalat_tasnee3_table.Rows.Count > 0)
                    {
                        ...
                        decimal pro_bee3_all = Convert.ToDecimal(dgr.Cells[6].Value) * Convert.ToDecimal(dgr.Cells[3].Value);

                        arba7_cat_tableTableAdapter1.Insert(DateTime.Today, dgr.Cells[2].Value.ToString(), pro_bee3_all - pro_cost_all, dgr.Cells[9].Value.ToString(), Convert.ToInt32(salesID_TXT.Text), "", far3txt.Text);


                        string cat = dgr.Cells[9].Value.ToString();
                        ...
                        sales_tableTableAdapter1.Insert(Convert.ToInt32(salesID_TXT.Text), dateTimePicker1.Value, cst_nameTXT.Text, cst_phoneTXT.Text, cst_addressTXT.Text, pro_bee3_all - pro_cost_all, Convert.ToDecimal(madfoo3TXT.Text), usertxt.Text, Convert.ToDecimal(discountTXT.Text), old_7esab_sab2, ba2y_el7esab_new, dgr.Cells[1].Value.ToString(), dgr.Cells[2].Value.ToString(),
                       Convert.ToDecimal(dgr.Cells[3].Value), Convert.ToDecimal(dgr.Cells[6].Value), notesTXT.Text, Convert.ToDouble(nesba_discount_txt.Text), 0, cat, Convert.ToDecimal(egmaly_kest_txt.Text), "نسبة", far3txt.Text
                       , mandoob_txt.Text, "", DateTime.Now.TimeOfDay, Convert.ToDecimal(dgr.Cells[5].Value), Convert.ToDecimal(dgr.Cells[4].Value), Convert.ToDecimal(dgr.Cells[7].Value),Convert.ToInt32(day_num_txt.Text));
            ...
            {
                ba2y_fatora = Convert.ToDecimal(ba2y_txt.Text);
            }
            ...
            if (type_txt.Text == "تعديل")
            {
                ...
                //{
                   ...
                   hesab_sab2_txt.Text = dataSet11.sales_table.Rows[0]["sales_7esab_sabe2"].ToString();
                    ...
                    {
                        dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), dr["sales_product_ID"].ToString(), dr["sales_product_name"].ToString(), dr["sales_product_count"].ToString(), dr["price_before_discount_nesba"].ToString(), dr["discount_nesba"].ToString(), dr["sales_unit_price"].ToString(), dr["sales_cat_extra"].ToString(), Convert.ToDecimal(dr["sales_price_for_sell"]) + Convert.ToDecimal(dr["sales_cat_extra"]), dr["sales_pro_category"].ToString());
                        if (dataGridView1.Columns.Count == 10)
                        {
                            DataGridViewButtonColumn btn = new DataGridViewButtonColumn();
        ...
        private void addbtn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; ++i)
            {
                ...
                {
                    serial_tableTableAdapter1.FillBy_serial_pro_id(dataSet11.serial_table, dataGridView1.Rows[i].Cells[1].Value.ToString());
            ...
            try
            {
                ...
                decimal price_after_discount = Convert.ToDecimal(unit_price) - (Convert.ToDecimal(unit_price) * (Convert.ToDecimal(discount_nesba_txt.Text) / 100));
               ...
               // double unit_price_after = Convert.ToDouble(unit_price);
                ...
                {
                    dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), pro_code, product_name, countTXT.Text, unit_price, discount_nesba_txt.Text, price_after_discount.ToString(), cat_extra, "", category_name1);
                    if (dataGridView1.Columns.Count == 10)
                    {
                        DataGridViewButtonColumn btn = new DataGridViewButtonColumn();
            ...
            catch
            {
                try
                {
                    serial_tableTableAdapter1.FillBy_serial_no(dataSet11.serial_table, product_nameTXT.Text);
                    int pro_id = Convert.ToInt32(dataSet11.serial_table.Rows[0]["serial_pro_id"]);

                    foreach (DataGridViewRow dgr in dataGridView1.Rows)
                    {
                        if (dgr.Cells[6].Value.ToString() == product_nameTXT.Text)
                        {
                            MessageBox.Show("هذا السيريال مضاف مسبقا في الفاتورة برجاء اختيار جهاز اخر");
                            product_nameTXT.Focus();
                            return;
                        }
                    }
                    ...
                    products_tableTableAdapter1.FillBy_int_code_and_far3(dataSet11.products_table, pro_id.ToString(), far3txt.Text);
                   ...
                   // double unit_price_after = Convert.ToDouble(unit_price);
                    ...
                    {
                        dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), pro_code, product_name, countTXT.Text, unit_price, discount_nesba_txt.Text, price_after_discount.ToString(), cat_extra,"", category_name1, product_nameTXT.Text);
                        if (dataGridView1.Columns.Count ==10)
                        {
                            DataGridViewButtonColumn btn = new DataGridViewButtonColumn();
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                else if (e.ColumnIndex == 3)
                {
                    ...
                    products_tableTableAdapter1.FillBy_name(dataSet11.products_table, pro_name);
                    decimal pro_count = Convert.ToDecimal(dataSet11.products_table.Rows[0]["pro_count"]);
        ...
        private void tas3eer_id_txt_MouseDown(object sender, MouseEventArgs e)
        {
                ...
                else
                {
                    try
                    {
                        ...
                        foreach (DataRow dr in dataSet11.tas3eer_table.Rows)
                        {
                            ...
                            // MessageBox.Show(dr["tas3eer_pro_category"].ToString());
                            decimal cat_extra = 0;
                            try
                            {
                                cat_extra = Convert.ToDecimal(dataSet11.Category.Rows[0]["cat_extra"]);
                            ...
                            //  MessageBox.Show(cat_extra.ToString());
                            dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), dr["tas3eer_product_ID"].ToString(), dr["tas3eer_product_name"].ToString(), dr["tas3eer_product_count"].ToString(), dr["tas3eer_unit_price"].ToString(), 0, dr["tas3eer_unit_price"].ToString(), cat_extra, "", dr["tas3eer_pro_category"].ToString());
        ...
        {
            if (dataGridView1.CurrentCell.ColumnIndex == 3 || dataGridView1.CurrentCell.ColumnIndex == 4 || dataGridView1.CurrentCell.ColumnIndex == 5 || dataGridView1.CurrentCell.ColumnIndex == 6 || dataGridView1.CurrentCell.ColumnIndex == 7)
            {
