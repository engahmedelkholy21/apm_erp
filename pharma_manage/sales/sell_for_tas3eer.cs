...
{
    public partial class sell_for_tas3eer : Form
    {
        public sell_for_tas3eer()
        {
            InitializeComponent();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                if (type_txt.Text != "تعديل")
                {
                    ...
                    salesID_TXT.Text = dataSet11.Numbers_table.Rows[0]["tas3eer_ID"].ToString();
                }
            }
            catch { }
            decimal sum = 0;
        ...
        private void suggest_product()
        {
            try
            {
                this.products_tableTableAdapter1.FillBy_stock_count_akbar_mn_0(this.dataSet11.products_table, far3txt.Text);
        ...
        private void sell_Load(object sender, EventArgs e)
        {
            ...
            {
                this.numbers_tableTableAdapter1.FillBy_stock(this.dataSet11.Numbers_table,far3txt.Text);
                salesID_TXT.Text = dataSet11.Numbers_table.Rows[1]["tas3eer_ID"].ToString();
            }
            catch { }
            
            sales_temp_tas3eer_tableTableAdapter1.FillBy_far3(dataSet11.sales_temp_tas3eer_table, far3txt.Text);
            if (dataSet11.sales_temp_tas3eer_table.Rows.Count > 0)
            {
                ...
                {
                    cst_nameTXT.Text = dataSet11.sales_temp_tas3eer_table.Rows[0]["sales_temp_tas3eer_cst_name"].ToString();
                    cst_phoneTXT.Text = dataSet11.sales_temp_tas3eer_table.Rows[0]["sales_temp_tas3eer_cst_phone"].ToString();
                    cst_addressTXT.Text = dataSet11.sales_temp_tas3eer_table.Rows[0]["sales_temp_tas3eer_cst_address"].ToString();
                    discountTXT.Text = dataSet11.sales_temp_tas3eer_table.Rows[0]["sales_temp_tas3eer_discount"].ToString();
                    nesba_discount_txt.Text = dataSet11.sales_temp_tas3eer_table.Rows[0]["sales_temp_tas3eer_nesba_discount"].ToString();

                    foreach (DataRow dr in dataSet11.sales_temp_tas3eer_table.Rows)
                    {
                        string category_name1 = "";
                        decimal dariba = 0;
                        try
                        {
                            category_name1 = dr["sales_temp_tas3eer_pro_category"].ToString();
                        ...
                        dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), dr["sales_temp_tas3eer_product_ID"].ToString(), dr["sales_temp_tas3eer_product_name"].ToString(), dr["sales_temp_tas3eer_product_count"].ToString(), dr["sales_temp_tas3eer_unit_price"].ToString(), "", category_name1);
                ...
                {
                    sales_temp_tas3eer_tableTableAdapter1.Delete_all_by_far3(far3txt.Text);
                }
            }
        ...
        private void save_fatora()
        {
            ...
            foreach (DataGridViewRow dgr in dataGridView1.Rows)
            {
                ...
                tas3eer_tableTableAdapter1.Insert(Convert.ToInt32(salesID_TXT.Text), dateTimePicker1.Value, cst_nameTXT.Text, cst_phoneTXT.Text, cst_addressTXT.Text
                         , 0, Convert.ToDecimal(madfoo3TXT.Text), usertxt.Text, Convert.ToDecimal(discountTXT.Text), 0, 0, dgr.Cells[1].Value.ToString(), dgr.Cells[2].Value.ToString(),
                         Convert.ToDecimal(dgr.Cells[3].Value), Convert.ToDecimal(dgr.Cells[4].Value),  notesTXT.Text, Convert.ToDouble(nesba_discount_txt.Text), Convert.ToDecimal(0), cat, Convert.ToDecimal(egmaly_kest_txt.Text), "", far3txt.Text
                         , mandoob_txt.Text, "");
            ...
            if (type_txt.Text != "تعديل")
            {
                numbers_tableTableAdapter1.Update_tas3eer_id(far3txt.Text);
            }
            //}
            //catch { }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                if (e.ColumnIndex == 7)
                {
                    ...
                    if (re == DialogResult.Yes)
                    {
                        sales_temp_tas3eer_tableTableAdapter1.Delete_pro_by_far3_name_code(far3txt.Text, pro_name, pro_code);
        ...
        private void addbtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), pro_code, product_name, countTXT.Text, unit_price_after, "", category_name1);

                    sales_temp_tas3eer_tableTableAdapter1.Insert(cst_nameTXT.Text, cst_phoneTXT.Text, cst_addressTXT.Text, Convert.ToDecimal(discountTXT.Text), pro_code, product_name, Convert.ToDecimal(countTXT.Text),
                  Convert.ToDecimal(unit_price_after), notesTXT.Text, Convert.ToDouble(nesba_discount_txt.Text), Convert.ToDecimal(0), category_name1, "", far3txt.Text
                        , mandoob_txt.Text, Convert.ToDecimal(nesba_discount_txt.Text), 0, 0);
            ...
            catch
            {
                try
                {
                    ...
                    {
                        dataGridView1.Rows.Add((dataGridView1.Rows.Count + 1).ToString(), pro_code, product_name, countTXT.Text, unit_price_after, "", category_name1, product_nameTXT.Text);
                        if (dataGridView1.Columns.Count == 7)
                        {
                            DataGridViewButtonColumn btn = new DataGridViewButtonColumn();
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                sales_temp_tas3eer_tableTableAdapter1.Update_pro_count_unit_price(Convert.ToDecimal(selectedRow.Cells[3].Value), Convert.ToDecimal(selectedRow.Cells[4].Value), far3txt.Text, pro_name1, pro_code1);
                sales_temp_tas3eer_tableTableAdapter1.Update_statics_by_far3(cst_nameTXT.Text, cst_phoneTXT.Text, cst_addressTXT.Text, Convert.ToDecimal(discountTXT.Text), Convert.ToDouble(nesba_discount_txt.Text),
        ...
        private void nesba_takseet_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (DataGridViewRow dgr in dataGridView1.Rows)
                {
                    dgr.Cells[4].Value = dgr.Cells[8].Value;// Convert.ToDecimal(dgr.Cells[4].Value) - (Convert.ToDecimal(dgr.Cells[4].Value) * elnesba);
                }
